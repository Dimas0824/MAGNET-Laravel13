...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        // Global middleware stack (was App\Http\Kernel::$middleware).
        $middleware->use([
            TrustProxies::class,
            HandleCors::class,
        ...
        // Route middleware groups (was App\Http\Kernel::$middlewareGroups).
        ...
        // Route middleware aliases (was App\Http\Kernel::$middlewareAliases).
        $middleware->alias([
